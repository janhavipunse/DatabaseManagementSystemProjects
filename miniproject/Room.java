...
public class Room extends JFrame {
	...
	public Room() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                l1.setBounds(520,0,530,550);
                add(l1);


		table = new JTable();
		table.setBounds(5, 40, 500, 400);
		...
		lblAvailability.setBounds(129, 15, 69, 14);
...
//		contentPane.add(lblCleanStatus);
		...
		lblNewLabel.setBounds(260, 15, 46, 14);
		contentPane.add(lblNewLabel);

		lblNewLabel_1 = new JLabel("Bed Type");
		lblNewLabel_1.setBounds(400, 15, 76, 14);
