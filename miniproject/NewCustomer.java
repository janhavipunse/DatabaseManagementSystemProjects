...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/newCust.jpg"));
		...
		lblName.setBounds(118, 16, 260, 53);
...
//		contentPane.add(comboBox);
		...
		lblCity.setBounds(35, 231, 200, 14);
		...
		contentPane.add(lblCheckInStatus);
                ...
                JLabel CheckInStatus = new JLabel(""+date);
		CheckInStatus.setBounds(270, 316, 200, 14);
		contentPane.add(CheckInStatus);
...
//		t5.setColumns(10);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String time =  CheckInStatus.getText();
                                String deposit =  t6.getText();

                                String q1 = "insert into customer values('"+Adhar+"','"+name+"','"+gender+"','"+city+"')";
                                String q2 = "insert into Book values('"+roomno+"','"+time+"','"+deposit+"','"+Adhar+"')";
                                
                                String q3 = "update room set availability = 'Occupied' where roomnumber = "+roomno;
